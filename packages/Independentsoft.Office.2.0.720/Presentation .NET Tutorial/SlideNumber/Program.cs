...
namespace Sample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Independentsoft.Office.Drawing.TextRun run1 = new Independentsoft.Office.Drawing.TextRun("Slide number: ");

            Independentsoft.Office.Drawing.TextField slideNumField = new Independentsoft.Office.Drawing.TextField();
            slideNumField.ID = "{3C8562DF-CFE0-4F15-B0BF-9CA7BAB9E0C0}";
            slideNumField.Type = "slidenum";

            Independentsoft.Office.Drawing.TextParagraph paragraph1 = new Independentsoft.Office.Drawing.TextParagraph();
            paragraph1 = new Independentsoft.Office.Drawing.TextParagraph();
            paragraph1.Alignment = Independentsoft.Office.Drawing.TextAlignmentType.Center;
            paragraph1.Content.Add(run1);
            paragraph1.Content.Add(slideNumField);

            ShapeTextBody textBody = new ShapeTextBody();
            textBody.Paragraphs.Add(paragraph1);

            Placeholder slideNumber = new Placeholder(PlaceholderType.SlideNumber);
            slideNumber.Size = PlaceholderSize.Quarter;
