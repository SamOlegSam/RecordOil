...
Module Module1
    Sub Main(ByVal args As String())
        ...
        Dim run1 As New Independentsoft.Office.Drawing.TextRun("Slide number: ")

        Dim slideNumField As New Independentsoft.Office.Drawing.TextField()
        ...
        Dim slideNumber As New Placeholder(PlaceholderType.SlideNumber)
