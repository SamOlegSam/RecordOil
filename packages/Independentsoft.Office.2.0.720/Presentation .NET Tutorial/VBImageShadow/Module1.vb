...
Module Module1
    Sub Main(ByVal args As String())
        ...
        Dim shadow As New Independentsoft.Office.Drawing.OuterShadowEffect()
        ...
        Dim shadowColor As New Independentsoft.Office.Drawing.PresetColor()
        shadowColor.Value = Independentsoft.Office.Drawing.PresetColorValue.Black

        shadow.ColorChoice = shadowColor

        Dim effectList As New Independentsoft.Office.Drawing.EffectList()
