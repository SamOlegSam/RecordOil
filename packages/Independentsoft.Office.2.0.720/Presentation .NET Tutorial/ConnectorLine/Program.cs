...
namespace Sample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Independentsoft.Office.Drawing.Outline line1 = new Independentsoft.Office.Drawing.Outline();
            line1.LineWidth = new Unit(2, UnitType.Pixel);
            line1.MiterJoinLimit = 400000;
            line1.SolidFill = new Independentsoft.Office.Drawing.SolidFill();

            Shape shape1 = new Shape();
            shape1.ID = "2";
            shape1.Name = "Connector 1";
            ...
            shape1.ShapeProperties.PresetGeometry = new Independentsoft.Office.Drawing.PresetGeometry(Independentsoft.Office.Drawing.ShapeType.StraightConnector1);
            shape1.ShapeProperties.Outline = line1;
